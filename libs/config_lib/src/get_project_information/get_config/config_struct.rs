    ...
    pub fn new() -> Result<Self, ConfigError<'static>> {
        ...
        let handle_config: ConfigStruct = ConfigStruct {
            ...
            params: Params {
                ...
                enable_provider_links_limit: bool_vars[&EnvBoolVar::EnableProviderLinksLimit],
            ...
            enable_providers_cleaning_warning_logs_db_in_mongo:
                EnableProvidersCleaningWarningLogsDbInMongo {
                    enable_cleaning_warning_logs_db_in_mongo_for_arxiv: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForArxiv],
                    enable_cleaning_warning_logs_db_in_mongo_for_biorxiv: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForBiorxiv],
                    enable_cleaning_warning_logs_db_in_mongo_for_github: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForGithub],
                    enable_cleaning_warning_logs_db_in_mongo_for_habr: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForHabr],
                    enable_cleaning_warning_logs_db_in_mongo_for_medrxiv: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForMedrxiv],
                    enable_cleaning_warning_logs_db_in_mongo_for_reddit: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForReddit],
                    enable_cleaning_warning_logs_db_in_mongo_for_twitter: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbInMongoForTwitter],
                },
            enable_providers_cleaning_warning_logs_db_collections_in_mongo:
                EnableProvidersCleaningWarningLogsDbCollectionsInMongo {
                    enable_cleaning_warning_logs_db_collections_in_mongo_for_arxiv: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbCollectionsInMongoForArxiv],
                    enable_cleaning_warning_logs_db_collections_in_mongo_for_biorxiv: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbCollectionsInMongoForBiorxiv],
                    enable_cleaning_warning_logs_db_collections_in_mongo_for_github: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbCollectionsInMongoForGithub],
                    ...
                    enable_cleaning_warning_logs_db_collections_in_mongo_for_medrxiv: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbCollectionsInMongoForMedrxiv],
                    enable_cleaning_warning_logs_db_collections_in_mongo_for_reddit: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbCollectionsInMongoForReddit],
                    enable_cleaning_warning_logs_db_collections_in_mongo_for_twitter: bool_vars[&EnvBoolVar::EnableCleaningWarningLogsDbCollectionsInMongoForTwitter],
                },
            enable_providers_time_measurement: EnableProvidersTimeMeasurement {
                enable_time_measurement_for_arxiv: bool_vars[&EnvBoolVar::EnableTimeMeasurementForArxiv],
                enable_time_measurement_for_biorxiv: bool_vars[&EnvBoolVar::EnableTimeMeasurementForBiorxiv],
                enable_time_measurement_for_github: bool_vars[&EnvBoolVar::EnableTimeMeasurementForGithub],
                enable_time_measurement_for_habr: bool_vars[&EnvBoolVar::EnableTimeMeasurementForHabr],
                enable_time_measurement_for_medrxiv: bool_vars[&EnvBoolVar::EnableTimeMeasurementForMedrxiv],
                enable_time_measurement_for_reddit: bool_vars[&EnvBoolVar::EnableTimeMeasurementForReddit],
                enable_time_measurement_for_twitter: bool_vars[&EnvBoolVar::EnableTimeMeasurementForTwitter],
            },
            ...
            enable_providers_links_limits: EnableProvidersLinksLimit {
                enable_links_limit_for_arxiv: bool_vars[&EnvBoolVar::EnableLinksLimitForArxiv],
                enable_links_limit_for_biorxiv: bool_vars[&EnvBoolVar::EnableLinksLimitForBiorxiv],
                enable_links_limit_for_github: bool_vars[&EnvBoolVar::EnableLinksLimitForGithub],
                enable_links_limit_for_habr: bool_vars[&EnvBoolVar::EnableLinksLimitForHabr],
                enable_links_limit_for_medrxiv: bool_vars[&EnvBoolVar::EnableLinksLimitForMedrxiv],
                enable_links_limit_for_reddit: bool_vars[&EnvBoolVar::EnableLinksLimitForReddit],
                enable_links_limit_for_twitter: bool_vars[&EnvBoolVar::EnableLinksLimitForTwitter],
            },
