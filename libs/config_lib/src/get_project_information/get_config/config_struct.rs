    ...
    pub fn new() -> Result<Self, ConfigError<'static>> {
        ...
        let handle_config: ConfigStruct = ConfigStruct {
            ...
            enable_providers_prints: EnableProvidersPrints {
                enable_prints_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsArxiv],
                enable_prints_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsBiorxiv],
                enable_prints_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsGithub],
                enable_prints_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsHabr],
                enable_prints_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsMedrxiv],
                enable_prints_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsReddit],
                enable_prints_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePrintsTwitter],
            },
            enable_warning_high_providers_prints: EnableWarningHighProvidersPrints {
                enable_warning_high_prints_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForArxiv],
                enable_warning_high_prints_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForBiorxiv],
                enable_warning_high_prints_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForGithub],
                enable_warning_high_prints_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForHabr],
                enable_warning_high_prints_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForMedrxiv],
                enable_warning_high_prints_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForReddit],
                enable_warning_high_prints_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningHighPrintsForTwitter],
            },
            enable_warning_low_providers_prints: EnableWarningLowProvidersPrints {
                enable_warning_low_prints_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForArxiv],
                enable_warning_low_prints_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForBiorxiv],
                enable_warning_low_prints_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForGithub],
                enable_warning_low_prints_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForHabr],
                enable_warning_low_prints_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForMedrxiv],
                enable_warning_low_prints_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForReddit],
                enable_warning_low_prints_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableWarningLowPrintsForTwitter],
            },
            enable_success_providers_prints: EnableSuccessProvidersPrints {
                enable_success_prints_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForArxiv],
                enable_success_prints_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForBiorxiv],
                enable_success_prints_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForGithub],
                enable_success_prints_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForHabr],
                enable_success_prints_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForMedrxiv],
                enable_success_prints_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForReddit],
                enable_success_prints_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableSuccessPrintsForTwitter],
            },
            enable_partial_success_providers_prints: EnablePartialSuccessProvidersPrints {
                enable_partial_success_prints_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForArxiv],
                enable_partial_success_prints_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForBiorxiv],
                enable_partial_success_prints_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForGithub],
                enable_partial_success_prints_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForHabr],
                enable_partial_success_prints_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForMedrxiv],
                enable_partial_success_prints_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForReddit],
                enable_partial_success_prints_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnablePartialSuccessPrintsForTwitter],
            },
            enable_error_providers_prints: EnableErrorProvidersPrints {
                enable_error_prints_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForArxiv],
                enable_error_prints_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForBiorxiv],
                enable_error_prints_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForGithub],
                enable_error_prints_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForHabr],
                enable_error_prints_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForMedrxiv],
                enable_error_prints_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForReddit],
                enable_error_prints_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableErrorPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableErrorPrintsForTwitter],
            },
            ...
            enable_providers_time_measurement: EnableProvidersTimeMeasurement {
                enable_time_measurement_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForArxiv],
                enable_time_measurement_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForBiorxiv],
                enable_time_measurement_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForGithub],
                enable_time_measurement_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForHabr],
                enable_time_measurement_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForMedrxiv],
                enable_time_measurement_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForReddit],
                enable_time_measurement_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableTimeMeasurement] && bool_vars[&EnvBoolVar::EnableTimeMeasurementPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableTimeMeasurementForTwitter],
            },
            enable_providers_info: EnableProvidersInfo {
                enable_info_for_arxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForArxiv],
                enable_info_for_biorxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForBiorxiv],
                enable_info_for_github: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForGithub],
                enable_info_for_habr: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForHabr],
                enable_info_for_medrxiv: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForReddit],
                enable_info_for_reddit: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForReddit],
                enable_info_for_twitter: bool_vars[&EnvBoolVar::EnableAllProvidersPrints] && bool_vars[&EnvBoolVar::EnableInfoPrintsForAllProviders] && bool_vars[&EnvBoolVar::EnableInfoForTwitter],
            },
