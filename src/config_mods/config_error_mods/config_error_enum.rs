...
pub enum ConfigErrorEnum<'a> {
    ...
    IsLinksLimitProvidersEnabledError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    ...
    IsTimeMeasurementPrintsEnabledError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    ...
    IsErrorPrintsEnabledAllProvidersError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    ...
    IsTimeMeasurementPrintsEnabledAllProvidersError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    ...
    IsInfoPrintsEnabledAllProvidersError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    ...
    IsErrorPrintsEnabledArxivError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsErrorPrintsEnabledBiorxivError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsErrorPrintsEnabledGithubError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsErrorPrintsEnabledHabrError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsErrorPrintsEnabledMedrxivError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsErrorPrintsEnabledRedditError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsErrorPrintsEnabledTwitterError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    ...
    IsLinksLimitEnabledArxivError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsLinksLimitEnabledBiorxivError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsLinksLimitEnabledGithubError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsLinksLimitEnabledHabrError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsLinksLimitEnabledMedrxivError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsLinksLimitEnabledRedditError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
    IsLinksLimitEnabledTwitterError {
        was_dotenv_enable: bool,
        env_name: &'a str,
        env_error: VarOrBoolParseError,
    },
