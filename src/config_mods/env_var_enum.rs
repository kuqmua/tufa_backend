...
pub enum EnvVar {
    ...
    MongoIsInitializationEnabled,
    MongoIsInitializationEnabledForProviders,
    MongoIsInitializationEnabledForArxiv,
    MongoIsInitializationEnabledForBiorxiv,
    MongoIsInitializationEnabledForGithub,
    MongoIsInitializationEnabledForHabr,
    MongoIsInitializationEnabledForMedrxiv,
    MongoIsInitializationEnabledForReddit,
    MongoIsInitializationEnabledForTwitter,
