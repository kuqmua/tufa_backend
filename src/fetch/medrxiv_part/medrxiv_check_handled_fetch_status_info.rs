...
use crate::config::{ENABLE_ERROR_PRINTS_MEDRXIV, ENABLE_PRINTS_MEDRXIV};
...
pub fn check_handled_fetch_status_info(
    ...
    let mut medrxiv_post_struct_wrapper_handle: RxivPostStruct = RxivPostStruct::new();
