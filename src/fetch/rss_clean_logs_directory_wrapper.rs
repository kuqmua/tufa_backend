...
pub fn rss_clean_logs_directory_wrapper() {
        ...
        .enable_cleaning_warning_logs_directory_for_arxiv
    {
        rss_clean_logs_directory(
            ProviderKind::Arxiv,
            CONFIG.params.enable_all_providers_prints && CONFIG.enable_prints.enable_prints_arxiv,
        ...
        .enable_cleaning_warning_logs_directory_for_biorxiv
    {
        rss_clean_logs_directory(
            ...
            CONFIG.params.enable_all_providers_prints && CONFIG.enable_prints.enable_prints_biorxiv,
            CONFIG.params.enable_error_prints_for_all_providers
        ...
        .enable_cleaning_warning_logs_directory_for_habr
    {
        rss_clean_logs_directory(
            ProviderKind::Habr,
            CONFIG.params.enable_all_providers_prints && CONFIG.enable_prints.enable_prints_habr,
            CONFIG.params.enable_error_prints_for_all_providers
        ...
        .enable_cleaning_warning_logs_directory_for_medrxiv
    {
        rss_clean_logs_directory(
            ...
            CONFIG.params.enable_all_providers_prints && CONFIG.enable_prints.enable_prints_medrxiv,
            CONFIG.params.enable_error_prints_for_all_providers
        ...
        .enable_cleaning_warning_logs_directory_for_reddit
    {
        rss_clean_logs_directory(
            ProviderKind::Reddit,
            CONFIG.params.enable_all_providers_prints && CONFIG.enable_prints.enable_prints_reddit,
            CONFIG.params.enable_error_prints_for_all_providers
        ...
        .enable_cleaning_warning_logs_directory_for_twitter
    {
        rss_clean_logs_directory(
            ...
            CONFIG.params.enable_all_providers_prints && CONFIG.enable_prints.enable_prints_twitter,
            CONFIG.params.enable_error_prints_for_all_providers
