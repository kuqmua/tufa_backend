...
use crate::helpers::http_request::get::error_for_status::http_request_error_for_status_error::HttpRequestErrorForStatusErrorEnum;
...
pub fn sync_http_request_error_for_status(
    ...
    match request_builder.send() {
        Err(e) => Err(Box::new(
            HttpRequestErrorForStatusError::init_error_with_possible_trace(
                HttpRequestErrorForStatusErrorEnum::ReqwestGet(e),
                WhereWas {
