...
use crate::helpers::http_request::get::status::http_request_status_error::HttpRequestStatusErrorEnum;
...
pub async fn async_http_request_status(
    ...
    match request_builder.send().await {
        Err(e) => Err(Box::new(
            HttpRequestStatusError::init_error_with_possible_trace(
                HttpRequestStatusErrorEnum::ReqwestGet(e),
                WhereWas {
