use crate::helpers::http_request::bytes::http_request_bytes_error::HttpRequestBytesError;
use crate::helpers::http_request::client_builder_error::ClientBuilderError;
use crate::helpers::http_request::content_length::http_request_content_length_error::HttpRequestContentLengthError;
use crate::helpers::http_request::json::http_request_json_error::HttpRequestJsonError;
use crate::helpers::http_request::remote_addr::http_request_remote_addr_error::HttpRequestRemoteAddrError;
use crate::helpers::http_request::text::http_request_text_error::HttpRequestTextError;
use crate::helpers::http_request::text_with_charset::http_request_text_with_charset_error::HttpRequestTextWithCharsetError;
use crate::helpers::http_request::version::http_request_version_error::HttpRequestVersionError;

use crate::helpers::http_request::bytes::async_http_request_bytes::async_http_request_bytes;
use crate::helpers::http_request::content_length::async_http_request_content_length::async_http_request_content_length;
use crate::helpers::http_request::json::async_http_request_json::async_http_request_json;
use crate::helpers::http_request::remote_addr::async_http_request_remote_addr::async_http_request_remote_addr;
use crate::helpers::http_request::text::async_http_request_text::async_http_request_text;
use crate::helpers::http_request::text_with_charset::async_http_request_text_with_charset::async_http_request_text_with_charset;
use crate::helpers::http_request::version::async_http_request_version::async_http_request_version;

use crate::helpers::http_request::bytes::sync_http_request_bytes::sync_http_request_bytes;
use crate::helpers::http_request::content_length::sync_http_request_content_length::sync_http_request_content_length;
use crate::helpers::http_request::json::sync_http_request_json::sync_http_request_json;
use crate::helpers::http_request::remote_addr::sync_http_request_remote_addr::sync_http_request_remote_addr;
use crate::helpers::http_request::text::sync_http_request_text::sync_http_request_text;
use crate::helpers::http_request::text_with_charset::sync_http_request_text_with_charset::sync_http_request_text_with_charset;
use crate::helpers::http_request::version::sync_http_request_version::sync_http_request_version;
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    match client_builder.build() {
        Err(e) => Err(Box::new(
            HttpRequestClientRequestBuilderPrepError::init_error_with_possible_trace(
                e,
                WhereWas {
