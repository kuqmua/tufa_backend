...
use crate::helpers::http_request::request_builder_methods::bytes::http_request_bytes_error::HttpRequestBytesErrorEnum;
    ...
    match request_builder.send() {
        Err(e) => Err(Box::new(
            HttpRequestBytesError::init_error_with_possible_trace(
                HttpRequestBytesErrorEnum::RequestBuilderSend(e),
                WhereWas {
