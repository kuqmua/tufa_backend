...
use crate::helpers::http_request::request_builder_methods::content_length::http_request_content_length_error::HttpRequestContentLengthErrorEnum;
...
pub fn sync_http_request_content_length(
    ...
    match request_builder.send() {
        Err(e) => Err(Box::new(
            HttpRequestContentLengthError::init_error_with_possible_trace(
                HttpRequestContentLengthErrorEnum::RequestBuilderSend(e),
                WhereWas {
