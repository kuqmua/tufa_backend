...
use crate::helpers::http_request::request_builder_methods::headers_mut::http_request_headers_mut_error::HttpRequestHeadersMutErrorEnum;
...
pub fn sync_http_request_headers_mut(
