...
use crate::helpers::http_request::request_builder_methods::bytes::http_request_bytes_error::HttpRequestBytesError;
...
pub struct HttpRequestWrapperBytesError {
    source: HttpRequestWrapperBytesErrorEnum,
    where_was: WhereWas,
}

#[derive(Debug, ImplGetSourceWithMethod, ImplGetWhereWasOneOrManyWithMethod)]
pub enum HttpRequestWrapperBytesErrorEnum {
