...
use crate::helpers::http_request::request_builder_methods::error_for_status::async_error_for_status::async_error_for_status;
...
pub async fn async_http_request_error_for_status_wrapper<
    //client generics
...
>(
    ...
    should_trace: bool,
) -> Result<(), Box<HttpRequestWrapperErrorForStatusError>>
where
    ...
    .await
    {
        Err(e) => Err(Box::new(
            HttpRequestWrapperErrorForStatusError::init_error_with_possible_trace(
                HttpRequestWrapperErrorForStatusErrorEnum::Prep(*e),
                WhereWas {
