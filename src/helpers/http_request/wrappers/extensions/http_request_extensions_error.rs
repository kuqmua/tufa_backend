...
// use crate::helpers::http_request::request_builder_methods::Extensions::http_request_Extensions_error::HttpRequestExtensionsError;
...
//     Extensions(HttpRequestExtensionsError),
// }
