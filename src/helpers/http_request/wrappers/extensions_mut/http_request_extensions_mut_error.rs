...
// use crate::helpers::http_request::request_builder_methods::extensions_mut::http_request_extensions_mut_error::HttpRequestExtensionsMutError;
...
//     ExtensionsMut(HttpRequestExtensionsMutError),
// }
