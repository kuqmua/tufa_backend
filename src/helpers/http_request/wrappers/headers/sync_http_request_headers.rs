...
use crate::helpers::http_request::request_builder_methods::headers::sync_http_request_headers::sync_http_request_headers;
...
pub async fn sync_http_request_headers_wrapper<
    //client generics
...
>(
    ...
    should_trace: bool,
) -> Result<reqwest::header::HeaderMap, Box<HttpRequestWrapperHeadersError>>
where
    ...
    .await
    {
        Err(e) => Err(Box::new(
            HttpRequestWrapperHeadersError::init_error_with_possible_trace(
                HttpRequestWrapperHeadersErrorEnum::Prep(*e),
                WhereWas {
        ...
        Ok(request_builder) => match sync_http_request_headers(request_builder, false) {
            Err(e) => Err(Box::new(
                HttpRequestWrapperHeadersError::init_error_with_possible_trace(
