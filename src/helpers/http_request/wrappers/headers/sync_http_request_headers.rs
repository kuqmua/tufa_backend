...
use crate::helpers::http_request::request_builder_methods::headers::sync_headers::sync_http_request_headers;
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    .await
    {
        ...
        Ok(request_builder) => match sync_headers(request_builder, false) {
            Err(e) => Err(Box::new(
                HttpRequestWrapperHeadersError::init_error_with_possible_trace(
