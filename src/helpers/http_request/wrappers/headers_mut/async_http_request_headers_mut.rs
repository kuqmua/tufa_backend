...
use crate::helpers::http_request::request_builder_methods::headers_mut::async_headers_mut::async_http_request_headers_mut;
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    .await
    {
        ...
        Ok(request_builder) => match async_headers_mut(request_builder, false).await {
            Err(e) => Err(Box::new(
                HttpRequestWrapperHeadersMutError::init_error_with_possible_trace(
