...
use crate::helpers::http_request::request_builder_methods::json::sync_http_request_json::sync_http_request_json;
...
pub async fn sync_http_request_json_wrapper<
    //client generics
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    .await
    {
        ...
        Ok(request_builder) => match sync_http_request_json(request_builder, false) {
            Err(e) => Err(Box::new(
                HttpRequestWrapperJsonError::init_error_with_possible_trace(
