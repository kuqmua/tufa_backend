...
use crate::helpers::http_request::request_builder_methods::status::async_status::async_http_request_status;
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    .await
    {
        ...
        Ok(request_builder) => match async_status(request_builder, false).await {
            Err(e) => Err(Box::new(
                HttpRequestWrapperStatusError::init_error_with_possible_trace(
