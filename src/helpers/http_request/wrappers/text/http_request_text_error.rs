...
use crate::helpers::http_request::request_builder_methods::text::http_request_text_error::HttpRequestTextError;
...
pub struct HttpRequestWrapperTextError {
    source: HttpRequestWrapperTextErrorEnum,
    where_was: WhereWas,
}

#[derive(Debug, ImplGetSourceWithMethod, ImplGetWhereWasOneOrManyWithMethod)]
pub enum HttpRequestWrapperTextErrorEnum {
