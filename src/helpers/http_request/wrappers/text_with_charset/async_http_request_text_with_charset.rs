...
use crate::helpers::http_request::request_builder_methods::text_with_charset::async_http_request_text_with_charset::async_http_request_text_with_charset;
    ...
    .await
    {
        Err(e) => Err(Box::new(
            HttpRequestWrapperTextWithCharsetError::init_error_with_possible_trace(
                HttpRequestWrapperTextWithCharsetErrorEnum::Prep(*e),
                WhereWas {
        ...
        Ok(request_builder) => {
            match async_http_request_text_with_charset(request_builder, default_encoding, false)
                .await
            {
                Err(e) => Err(Box::new(
                    HttpRequestWrapperTextWithCharsetError::init_error_with_possible_trace(
