...
use crate::helpers::http_request::request_builder_methods::url::async_url::async_http_request_url;
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    .await
    {
        ...
        Ok(request_builder) => match async_url(request_builder, false).await {
            Err(e) => Err(Box::new(
                HttpRequestWrapperUrlError::init_error_with_possible_trace(
