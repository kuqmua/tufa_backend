...
use crate::helpers::http_request::request_builder_methods::url::async_http_request_url::async_http_request_url;
...
pub async fn async_http_request_url_wrapper<
    //client generics
...
>(
    ...
    should_trace: bool,
) -> Result<reqwest::Url, Box<HttpRequestWrapperUrlError>>
where
    ...
    .await
    {
        Err(e) => Err(Box::new(
            HttpRequestWrapperUrlError::init_error_with_possible_trace(
                HttpRequestWrapperUrlErrorEnum::Prep(*e),
                WhereWas {
        ...
        Ok(request_builder) => match async_http_request_url(request_builder, false).await {
            Err(e) => Err(Box::new(
                HttpRequestWrapperUrlError::init_error_with_possible_trace(
