...
use crate::helpers::http_request::request_builder_methods::version::async_http_request_version::async_http_request_version;
...
pub async fn async_http_request_version_wrapper<
    //client generics
...
>(
    ...
    should_trace: bool,
) -> Result<reqwest::Version, Box<HttpRequestWrapperVersionError>>
where
    ...
    BearerAuthGeneric: std::fmt::Display,
{
    ...
    .await
    {
        ...
        Ok(request_builder) => match async_http_request_version(request_builder, false).await {
            Err(e) => Err(Box::new(
                HttpRequestWrapperVersionError::init_error_with_possible_trace(
