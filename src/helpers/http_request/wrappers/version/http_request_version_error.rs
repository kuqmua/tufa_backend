...
use crate::helpers::http_request::request_builder_methods::version::http_request_version_error::HttpRequestVersionError;
...
pub struct HttpRequestWrapperVersionError {
    source: HttpRequestWrapperVersionErrorEnum,
    where_was: WhereWas,
}

#[derive(Debug, ImplGetSourceWithMethod, ImplGetWhereWasOneOrManyWithMethod)]
pub enum HttpRequestWrapperVersionErrorEnum {
