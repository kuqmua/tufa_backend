...
pub async fn mongo_insert_many<'a>(
    ...
    let error_vec_insert_many = futures::future::join_all(
        ...
        if let Err(e) = result {
            return Some((
                pk.to_string(), 
                tufa_common::repositories_types::tufa_server::mongo_integration::mongo_insert_many::MongoInsertManyOriginErrorUnnamed::Mongo(
                    tufa_common::repositories_types::tufa_server::mongo_integration::mongo_insert_many::MongoInsertManyOriginErrorNamed::Mongo { 
                        error: e, 
    ...
    .collect::<std::collections::HashMap<String, tufa_common::repositories_types::tufa_server::mongo_integration::mongo_insert_many::MongoInsertManyOriginErrorUnnamed>>();
