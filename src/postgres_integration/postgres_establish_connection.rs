pub async fn postgres_establish_connection<'a>(
    max_connections: u32,
) -> Result<sqlx::Pool<sqlx::Postgres>, Box<tufa_common::repositories_types::tufa_server::postgres_integration::postgres_establish_connection::PostgresEstablishConnectionErrorNamed<'a>>> {
    ...
    {
        Err(e) => Err(Box::new(
            tufa_common::repositories_types::tufa_server::postgres_integration::postgres_establish_connection::PostgresEstablishConnectionErrorNamed::Connect { 
                sqlx_error: e, 
