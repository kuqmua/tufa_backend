pub async fn git_info_json() -> impl actix_web::Responder {
    actix_web::web::Json(tufa_common::common::git::git_info::GitInformation {
        ...
        git_author_email: &crate::global_variables::compile_time::git_info::GIT_INFO.git_author_email,
        git_commit_unix_time: &crate::global_variables::compile_time::git_info::GIT_INFO.git_commit_unix_time,
