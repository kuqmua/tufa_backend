...
//     fn remove_logs_directory(&self) -> Result<(), tufa_common::repositories_types::tufa_server::providers::provider_kind::provider_kind_enum::CleanLogsDirError>;
...
//     where
//         Self: Sized;
//     fn remove_existing_providers_logs_directories() -> Result<(), std::collections::HashMap<Self, tufa_common::repositories_types::tufa_server::providers::provider_kind::provider_kind_enum::RemoveDirError>>
//     where
//         Self: Sized;
//     fn remove_providers_logs_directories() -> Result<(), std::collections::HashMap<Self, tufa_common::repositories_types::tufa_server::providers::provider_kind::provider_kind_enum::CleanLogsDirError>>
//     where
//         Self: Sized;
